...
export default function Hero() {
  ...
  return (
    <section id="home" className="hero-shell relative isolate min-h-screen overflow-hidden px-5 pt-28 sm:px-8 lg:px-12">
      <motion.div className="hero-light" style={{ opacity: glowOpacity }} aria-hidden="true" />
      ...
      <div className="mx-auto grid min-h-[calc(100vh-7rem)] max-w-7xl items-center gap-10 lg:grid-cols-[1.03fr_0.97fr]">
        <motion.div
          ...
          animate="visible"
        >
          <motion.p variants={slowReveal} className="mb-5 font-display text-sm font-semibold uppercase text-signal-cyan">
            {hero.role}
          </motion.p>
          ...
          >
            ...
            <span className="block translate-x-[8vw] text-outline sm:translate-x-[11vw]">Bhure</span>
          </motion.h1>

          <motion.div variants={slowReveal} className="mt-8 max-w-2xl">
            <p className="font-display text-3xl font-semibold leading-tight text-white sm:text-5xl">{hero.statement}</p>
            <p className="mt-5 max-w-xl text-base leading-8 text-white/60 sm:text-lg">{hero.subcopy}</p>
          </motion.div>

          <motion.div variants={slowReveal} className="mt-8 flex flex-wrap items-center gap-3">
          ...
          <motion.div variants={slowReveal} className="mt-8 flex flex-wrap items-center gap-3">
            <span className="mr-2 hidden h-px w-16 bg-white/20 sm:block" aria-hidden="true" />
            {socials.map((social) => {
        ...
        <motion.div className="relative z-0 min-h-[540px] lg:min-h-[720px]" style={{ y: visualY }}>
          ...
          <motion.div className="portrait-stage" {...tilt.handlers} style={tilt.style}>
            <div className="portrait-shadow" aria-hidden="true" />
            <img src={assets.portrait} alt="Half human half digital portrait of Arnav Bhure" className="portrait-image" />
          ...
          <div className="hero-meta-panel">
            ...
            <span>React / Product UI / Problem Solving</span>
          </div>
        </motion.div>
      </div>
    </section>
